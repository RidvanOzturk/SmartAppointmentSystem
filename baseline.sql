...
VALUES ('20250224092052_initialCreate', '9.0.2');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250228160852_addedLogEntity', '9.0.2');

ALTER TABLE "Doctors" ALTER COLUMN "Description" DROP NOT NULL;

ALTER TABLE "Doctors" ALTER COLUMN "BranchId" DROP NOT NULL;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20250307090501_editedDoctorEntity', '9.0.2');
